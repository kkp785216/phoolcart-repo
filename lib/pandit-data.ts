...
export const panditJis: PanditJi[] = [
  {
    ...
    description:
      "Experienced Pandit Ji specializing in Vedic rituals and traditional ceremonies.",
    detailedExperience:
    ...
    testimonials: [
      ...
      },
      {
        ...
        review:
          "Very knowledgeable and punctual. Explained every ritual clearly and made the ceremony meaningful.",
        rating: 5,
      },
    ],
  },
  {
    ...
    description:
      "Expert in Vedic astrology and traditional Hindu ceremonies with deep spiritual knowledge.",
    detailedExperience:
  ...
  },
  {
    ...
    description:
      "Devoted Krishna bhakt specializing in Vaishnav traditions and devotional ceremonies.",
    detailedExperience:
    ...
    testimonials: [
      {
        ...
        review:
          "His devotional recitation brought tears to our eyes. Truly a blessed soul with divine connection.",
        rating: 5,
      },
    ],
  },
  {
    ...
    description:
      "Senior Pandit Ji with extensive knowledge of Shaivite traditions and remedial rituals.",
    detailedExperience:
    ...
    testimonials: [
      {
        ...
        review:
          "Pandit Ji's powerful chanting and spiritual energy created a divine atmosphere. Highly recommended.",
        rating: 5,
      },
    ],
  },
  {
    ...
    description:
      "Specialist in Devi worship and women-centric festivals with compassionate approach.",
    detailedExperience:
    ...
    testimonials: [
      {
        ...
        review:
          "Very understanding and patient. Made the ceremony special for all the ladies in our family.",
        rating: 5,
      },
    ],
  },
  {
    ...
    description:
      "Renowned spiritual guide combining traditional rituals with modern spiritual practices.",
    detailedExperience:
    ...
    testimonials: [
      {
        ...
        review:
          "Pandit Ji's guidance transformed my life. His blend of tradition and modern wisdom is remarkable.",
        rating: 5,
      },
    ],
  },
...
export function getPanditBySlug(slug: string): PanditJi | undefined {
  return panditJis.find((pandit) => pandit.slug === slug);
}
