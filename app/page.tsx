        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-2 text-balance">
              Find Experienced Pandit Jis
            </h1>
            <p className="text-xl opacity-90 text-pretty">
              Connect with qualified Hindu priests for all your spiritual
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-foreground mb-2">
            Available Pandit Jis in Your Area
          </h2>
          <p className="text-muted-foreground">
            Browse through our verified and experienced Pandit Jis. Click on any
            profile to view detailed information.
          </p>
        </div>
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  <Link href={`/pandit/${pandit.slug}`} className="flex-1">
        ...
        <div className="mt-16 bg-gradient-to-br from-secondary/10 to-accent/10 rounded-lg p-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6 text-pretty max-w-2xl mx-auto">
              Access our comprehensive collection of sacred texts, devotional
              hymns, and spiritual literature. Read Chalisas, Aartis, Stutis,
              and Paths with audio support for enhanced devotion.
            </p>
        ...
        <div className="mt-16 text-center bg-muted rounded-lg p-8">
          <h3 className="text-2xl font-semibold text-foreground mb-4">
            Need Help Finding the Right Pandit Ji?
          </h3>
          <p className="text-muted-foreground mb-6 text-pretty">
            Our team can help you find the perfect Pandit Ji for your specific
            ceremony or ritual requirements.
          </p>
          <Button
            size="lg"
