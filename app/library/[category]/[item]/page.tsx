        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-balance">{item.title}</h1>
                {item.description && (
                  <p className="text-sm md:text-base opacity-90 text-pretty mt-1">{item.description}</p>
                )}
                <div className="flex items-center gap-2 mt-2">
                  ...
                  {item.youtubeId && (
                    <Badge variant="outline" className="text-xs bg-transparent border-primary-foreground/20">
              ...
              <div className="prose prose-lg max-w-none">
                <div className="bg-gradient-to-br from-muted/30 to-muted/10 rounded-lg p-6 md:p-8">
                  <div className="text-center mb-8">
                    <div className="text-2xl md:text-3xl font-bold text-primary mb-2">{item.title}</div>
                  ...
                  <div className="space-y-4 text-foreground leading-relaxed">
                    {item.content.split("\n").map((line, index) => {
                      ...
                      if (trimmedLine.includes("॥") || trimmedLine.startsWith("ॐ") || trimmedLine.includes("दोहा")) {
                        return (
                          <div key={index} className="text-center font-semibold text-primary text-lg md:text-xl py-2">
                            {trimmedLine}
                          </div>
                        )
                      }
            ...
            <Card className="mt-8 border-primary/20">
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mt-3">
                  Listen along while reading for proper pronunciation and rhythm. Audio helps enhance your spiritual
      ...
      <footer className="bg-card border-t border-border mt-16">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center text-muted-foreground">
            <p className="mb-2">May this sacred recitation bring you peace and spiritual fulfillment</p>
            <p className="text-sm">"मन्त्रहीनं क्रियाहीनं भक्तिहीनं सुरेश्वर" - Without devotion, all practices are incomplete</p>
          </div>
        </div>
      </footer>
    </div>
